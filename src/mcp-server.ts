...
function createServer(): McpServer {
  ...
  server.registerTool(
    'browser_click_ref',
    {
      ...
      description:
        'Click one Playwright reference from the latest semantic snapshot of the same document and frame. A fresh offscreen ref receives one bounded scroll-into-view step followed by uniqueness and actionability revalidation; preparation failures report actionDispatched false. Stale, unknown, reused, or no-longer-unique references fail closed. Optional postconditions verify the requested state change; failures record sanitized actionability evidence.',
