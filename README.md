...
| `browser_click_ref` | Incrementally bring one fresh observed reference into view, uniquely rebind it within the same article after feed virtualization, and click only when safely actionable |
