...
The additive 0.15.5–0.15.9 evidence is recorded in the corresponding dogfooding records; it does not replace or reinterpret the historical 0.13 gate above.
